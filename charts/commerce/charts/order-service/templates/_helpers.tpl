{{/*
Named templates for order-service.
...
Release-qualified resource name, e.g. "dev-order-service". Truncated to
K8s' 63-char limit. The contains-check avoids the silly
"dev-dev-order-service" when the release name already contains the
chart name.
*/}}
